...
<script>
    ...
    async function loadSequenceList() {
        try {
            const response = await fetch('/seq/list');
    ...
    async function sequencePlay(name) {
        try {
            const response = await fetch(`/seq/play?name=${encodeURIComponent(name)}`);
            if (!response.ok) throw new Error('Failed to play sequence');

            showFeedback(`Playing: ${name}`, 'success');
    ...
    async function sequenceStop() {
        try {
            const response = await fetch('/seq/stop');
    ...
    async function sequenceDelete(name) {
        ...
        try {
            const response = await fetch(`/seq/delete?name=${encodeURIComponent(name)}`);
            if (!response.ok) throw new Error('Failed to delete sequence');

            showFeedback(`Deleted: ${name}`, 'success');
            setTimeout(loadSequenceList, 500);
        } catch (error) {
            showFeedback('Error: ' + error.message, 'error');
        }
    }
    ...
    async function playlistAdd(name) {
        try {
            const response = await fetch(`/seq/playlist/add?name=${encodeURIComponent(name)}`);
            if (!response.ok) throw new Error('Failed to add to playlist');

            showFeedback(`Added to playlist: ${name}`, 'success');
            setTimeout(loadPlaylistStatus, 500);
        } catch (error) {
            showFeedback('Error: ' + error.message, 'error');
        }
    ...
    async function playlistClear() {
        try {
            const response = await fetch('/seq/playlist/clear');
            if (!response.ok) throw new Error('Failed to clear playlist');

            showFeedback('Playlist cleared', 'success');
            setTimeout(loadPlaylistStatus, 500);
        } catch (error) {
            showFeedback('Error: ' + error.message, 'error');
        }
    ...
    async function playlistPlay() {
        try {
            const response = await fetch('/seq/playlist/play');
            if (!response.ok) throw new Error('Failed to play playlist');

            showFeedback('Playing playlist', 'success');
            setTimeout(loadPlaylistStatus, 500);
        } catch (error) {
            showFeedback('Error: ' + error.message, 'error');
        }
    ...
    async function playlistLoop() {
        try {
            const response = await fetch('/seq/playlist/loop');
            if (!response.ok) throw new Error('Failed to loop playlist');

            showFeedback('Looping playlist', 'success');
            setTimeout(loadPlaylistStatus, 500);
        } catch (error) {
            showFeedback('Error: ' + error.message, 'error');
        }
    ...
    async function loadPlaylistStatus() {
        try {
            const response = await fetch('/seq/playlist/get');
    ...
    async function loadIRMappings() {
        try {
            const response = await fetch('/seq/map/list');
            if (!response.ok) throw new Error('Failed to load IR mappings');
    ...
    async function irMapClear(buttonName) {
        ...
        try {
            const response = await fetch(`/seq/map/clear?button=${encodeURIComponent(buttonName)}`);
            if (!response.ok) throw new Error('Failed to clear mapping');

            showFeedback(`Cleared mapping for: ${buttonName}`, 'success');
            setTimeout(loadIRMappings, 500);
        } catch (error) {
            showFeedback('Error: ' + error.message, 'error');
        }
    }
