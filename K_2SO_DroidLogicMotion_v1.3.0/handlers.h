...
void handleSeqVerify();              // Verify sequence file
void handleSeqVerifyAll();           // Verify all sequence files
void handleSeqStats();               // Sequence storage stats
void handleSeqDuplicate();           // Duplicate sequence
void handleSeqExport();              // Export raw sequence JSON
void handleSeqImport();              // Import raw sequence JSON
void handleSeqPlaylistAdd();         // Add to playlist
void handleSeqPlaylistRemove();      // Remove playlist item
void handleSeqPlaylistMove();        // Reorder playlist item
void handleSeqPlaylistSave();        // Save current playlist
void handleSeqPlaylistLoad();        // Load saved playlist
void handleSeqPlaylistList();        // List saved playlists
void handleSeqPlaylistClear();       // Clear playlist
void handleSeqPlaylistPlay();        // Play playlist
void handleSeqPlaylistLoop();        // Loop playlist
void handleSeqPlaylistGet();         // Get playlist (JSON)
void handleSeqMapList();             // Get IR mappings (JSON)
void handleSeqMapSet();              // Set IR mapping
void handleSeqMapClear();            // Clear IR mapping
...
void handleSequenceCommand(String params); // Sequence recording and playback
