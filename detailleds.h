...
#define DETAIL_BLINK_ON_MS      200     // Blink on duration
#define DETAIL_BLINK_OFF_MS     800     // Blink off duration
...
#define DETAIL_RANDOM_MIN_MS    50      // Random flicker minimum interval
#define DETAIL_RANDOM_MAX_MS    300     // Random flicker maximum interval
